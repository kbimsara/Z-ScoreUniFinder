...
4. Install dependencies:
   ...
   ```
6. Ensure the dataset (`data/dataset.csv`) is in the `back-end/data/` directory (see [Dataset Requirements](#dataset-requirements)). You can download the dataset from Kaggle and Hugging Face platforms.
